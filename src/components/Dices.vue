...
.spinner .face1 { 
    ...
    background-image: url("/asset/dice-1.png");
...
.spinner .face2 { 
    ...
    background-image: url("/asset/dice-2.png");
    background-position: center;
    background-size: cover;
}
.spinner .face3 { 
    ...
    background-image: url("/asset/dice-3.png");
    background-position: center;
    background-size: cover;
}
.spinner .face4 { 
    ...
    background-image: url("/asset/dice-4.png");
    background-position: center;
    background-size: cover;
}
.spinner .face5 { 
    ...
    background-image: url("/asset/dice-5.png");
    background-position: center;
    background-size: cover;
}
.spinner .face6 { 
    ...
    background-image: url("/asset/dice-6.png");
    background-position: center;
    background-size: cover;
}
